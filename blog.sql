/*
 ...
 Source Host           : 47.108.222.21:3306
 Source Schema         : blog
...
CREATE TABLE `t_comment`  (
  ...
  CONSTRAINT `FK4jj284r3pb7japogvo6h72q95` FOREIGN KEY (`parent_comment_id`) REFERENCES `t_comment` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FKke3uogd04j4jx316m1p51e05u` FOREIGN KEY (`blog_id`) REFERENCES `t_blog` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES (1, 'https://s3.bmp.ovh/imgs/2021/08/06438835f7c58b4f.jpg', '2021-06-08 12:48:17.000000', 'pangzy1013@gmail.com', 'nice', '63a9f0ea7bb98050796b649e85481845', NULL, '2021-06-08 12:48:48.000000', 'nice');
